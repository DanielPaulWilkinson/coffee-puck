    ...
    <div>
        <fieldset :aria-labelledby="`${name}-id`">
            ...
            <div class="row">
                ...
                <div v-if="tooltip" class="order-last col-1">
                    <div data-placement="right" title="Click for help text!" class="w-25">
                        <button aria-label="Click for help text" class="btn-circular font-weight-bold pulse"
                            type="button" aria-expanded="false" :aria-controls="name + '_collapse'"
